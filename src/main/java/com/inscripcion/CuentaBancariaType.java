...
/** CuentaBancariaType bean class */
@SuppressWarnings({"unchecked", "unused"})
public class CuentaBancariaType implements org.apache.axis2.databinding.ADBBean {
  /* This type was generated from the piece of schema that had
  name = cuentaBancariaType
  Namespace URI = http://inscripcion.com
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":cuentaBancariaType",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static CuentaBancariaType parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      CuentaBancariaType object = new CuentaBancariaType();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"cuentaBancariaType".equals(type)) {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("http://inscripcion.com", "saldo")
                .equals(reader.getName())) {
          ...
          if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
            throw new org.apache.axis2.databinding.ADBException(
                "The element: " + "saldo" + "  cannot be null");
          }
