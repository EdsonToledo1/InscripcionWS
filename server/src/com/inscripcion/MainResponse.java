...
/** MainResponse bean class */
@SuppressWarnings({"unchecked", "unused"})
public class MainResponse implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("http://inscripcion.com", "mainResponse", "ns1");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":mainResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mainResponse", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static MainResponse parse(javax.xml.stream.XMLStreamReader reader)
